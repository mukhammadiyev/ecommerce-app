import topLeftImage from "@images/about1.webp";
import bottomLeftImage from "@images/about3.webp";
import rightImage from "@images/about2.webp";
import rightBackImage from "@images/about4.webp";
...
export default function Home({
  ...
  return (
    <div>
      {/* ── 1. Hero / intro ── */}
      <section className="h-[70vh] lg:h-full relative w-full flex flex-col justify-center items-center overflow-hidden">
      ...
      <section className="w-full bg-white">
        <div className="w-full container mx-auto px-5 sm:px-8 2xl:px-27 py-5 2xl:py-10 flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between mb-12 sm:mb-20 lg:mb-25">
          ...
          <div
            ref={collageRef}
            className="hidden md:flex relative items-end gap-2"
          >
            ...
            <div className="relative flex flex-col items-end justify-end">
              <div className="absolute -top-16 -right-4 w-full h-full rounded-2xl bg-[#e0e0e0] translate-x-3 translate-y-0 overflow-hidden">
                <img
                  src={rightBackImage}
                  alt=""
                  className="w-full h-full object-cover"
      ...
      <section
        ref={statsSectionRef}
        className="w-full h-screen lg:h-max bg-[#757575] text-white flex flex-col items-center justify-center"
      >
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between mb-6 sm:mb-10">
          <div className="flex flex-col gap-2 max-w-md">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              Stay updated with our latest news, detailed stories and special
              articles straight from our authors.
            </p>
          </div>
          <a
            href="/blogs"
      ...
      <section className="w-full container mx-auto bg-white px-5 sm:px-6 py-14 sm:py-20 lg:py-25 2xl:px-27">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between mb-8 sm:mb-10">
          ...
          <p className="text-sm text-gray-500 leading-relaxed max-w-md">
            Check out our most popular and newly arrived products curated
            carefully for you.
          </p>
        </div>
